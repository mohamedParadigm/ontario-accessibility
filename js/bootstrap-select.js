      ...
      if (this.options.liveSearch) {
        searchbox =
          '<div class="bs-searchbox">' +
            '<input type="text" class="form-control2" autocomplete="off"' +
              (
    ...
    selectPosition: function () {
      ...
      var that = this,
          ...
          getPlacement = function ($element) {
            ...
            that.$bsContainer.addClass($element.attr('class').replace(/form-control2|fit-width/gi, '')).toggleClass(classNames.DROPUP, $element.hasClass(classNames.DROPUP));
            pos = $element.offset();
